...
import 'package:medicine_reminder/Enhancements/ConfirmButton/Widgets.dart';
...
class PacmanIcon extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Image.asset('assets/images/MaplogoV2.png',
          height: screenAwareSize(30.0, context),
      width: screenAwareSize(26.0, context),
      )
      // SvgPicture.asset(
      //   'images/pacman.svg',
      //
