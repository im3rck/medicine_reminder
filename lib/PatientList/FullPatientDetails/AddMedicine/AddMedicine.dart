...
import 'package:medicine_reminder/PatientController/Cards/Medicine/MedicineAddon.dart';
...
class AddMedicine extends StatefulWidget {
  AddMedicine(this.patientToken);
  String patientToken;
  _Medicines createState() => _Medicines();
}

class _Medicines extends State<AddMedicine> {
  // void initState(){
  //   Pink();
  // }
  // Pink() async {
    ...
    showModalBottomSheet(
      ...
      builder: (context) {
        return Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          _choice(
              AppLocalizations.of(context).translate('By_Medicine'),
              AppLocalizations.of(context)
                  .translate('Set_Schedule_for_Medicines'),
              0),
        ]);
      },
    );
